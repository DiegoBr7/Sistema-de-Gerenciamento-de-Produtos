...
No exemplo abaixo o projeto foi executado no IntelliJ:
...
No VS Code, basta usar o Go Live (Live Server):
...
Configure o Postman em Authorization → Bearer Token
...
6️⃣ Produto – Buscar por Nome (Filtro)
...
7️⃣ Produto – Excluir (Supervisor apenas)
...
Supervisor → pode adicionar, editar e excluir.

Analista → pode apenas visualizar e adicionar :
...
link da imagem : https://github.com/user-attachments/assets/e23a1e28-8cd2-4942-8f5b-1ac7ae0138a7
...
link da imagem : https://github.com/user-attachments/assets/777943ba-dfaf-48c7-b629-a8b7f9ded0a0

Página login novamente :
